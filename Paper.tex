...
\frenchspacing\onehalfspacing
\input{tex/simulationdefinitions}
\input{tex/empiricsdefinitions}
...
\author{Gray Calhoun\thanks{ Economics Department; Iowa State
    ...
    Group meeting for helpful comments.  I'd also like to thank Amit
...
\date{\input{VERSION% <- allows VERSION to have comments
}}
\maketitle
...
\citet{Wes:96}.\footnote{Other papers in this literature include
  ...
  \citet{ClM:01,ClM:05-2,ClM:05,ClM:11b,ClM:11,ClM:12},
...
study.\footnote{All of these simulations were programmed in R
  ...
  programming, please see the supplemental appendices
  \citep{Cal:11f,Cal:11g,Cal:11h}.}  I'll use both of the \dgp s they
consider as well as a modification to study the performance of the
statistics if there is instability.
